...
#    plt.show()
    ...
    run_time_start = time()
    Org_img_Disc_flat = rotate(cv2.linearPolar(org_img_disc_region, (DiscROI_size/2,
                                                                     DiscROI_size/2), DiscROI_size/2, cv2.WARP_FILL_OUTLIERS), -90)
...
#    plt.show()
    ...
    Img_result[crop_coord[0]:crop_coord[1], crop_coord[2]:crop_coord[3],
               ] = ROI_result[err_coord[0]:err_coord[1], err_coord[2]:err_coord[3], ]
